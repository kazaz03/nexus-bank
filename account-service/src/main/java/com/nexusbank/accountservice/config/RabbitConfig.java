...
/**
 * Account-service side of the loan disbursement saga (F14).
 *
 * Declares the same exchange and queues as loan-service so either service can
 * boot first and the topology will exist either way (idempotent).
 */
@Configuration
